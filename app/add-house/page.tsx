...
export default function AddHousePage() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    toast.success(`Maison "${values.address}" ajoutée avec succès.`);
    reset();
    setLevels([]);
  ...
  return (
    <DashboardLayout
      ...
      description="Enregistrez une nouvelle propriété dans votre parc immobilier"
    >
      <div className="w-full max-w-xl">
        <Card className="border-border shadow-sm">
          <CardHeader>
            <CardTitle className="text-base">Informations de la maison</CardTitle>
            <CardDescription>
              Renseignez les détails de votre bien immobilier.
            </CardDescription>
          </CardHeader>
          <CardContent>
